...
export interface ApiConsultantConsultant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    areaOfPractice: Schema.Attribute.RichText;
    contacts: Schema.Attribute.Component<'elements.link', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    experienceHighlight: Schema.Attribute.RichText;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      [
        'blocks.hero-with-bg-video',
        'blocks.text-with-side-image',
        'blocks.service-offerings',
        'blocks.consultant-spotlight',
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    reference: Schema.Attribute.Component<'elements.link', false>;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    slug: Schema.Attribute.UID<'title'>;
    ...
    topic: Schema.Attribute.Relation<'manyToOne', 'api::service.service'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
